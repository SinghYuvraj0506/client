...
export const HeroSectionData = [
    {
        img: "https://images-eu.ssl-images-amazon.com/images/G/31/img20/Wireless/ElectronicsStore/GW/New/1242x450.jpg",
        title: "Electronics",
...
export const footerData = [
  {
    ...
    links: ["Headphones", "Laptops", "Cameras", "Smart Watches"],
    linkUrl: 'electronics'
  },
  {
    category: "Jewelry",
  ...
  },
  {
    ...
    links: ["T-Shirts", "Shirts", "Jeans", "Jackets"],
    linkUrl:"men's clothing"
  },
  {
    category: "Women's Clothing",
    links: ["Dresses", "Tops", "Skirts", "Blazers"],
    linkUrl:"women's clothing"
  }
];
